...
<main>
    <div class="container-img">
        <img
            src="/lyons.peru/images/pesas.jpg"
            alt="imagen-producto"
        />
    </div>
    <div class="container-info-product">
        <div class="container-price">
            <span>Energetics Pesas Fitness Neopreno </span>
        </div>
        ...
        <div class="container-add-cart">
            ...
            <div class="product" data-product-name="Energetics Pesas Fitness Neopreno" data-product-price="113.99">
        ...
        <div class="container-description">
            ...
            <div class="text-description">
                <p>
                    Las Neoprene Dumbbells son unas mancuernas para hacer ejercicios. Están hechas de resistentes materiales para fortalecer tus brazos, hombros y pecho.
                </p>
            </div>
        </div>
