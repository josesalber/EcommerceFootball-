...
<main>
    <div class="container-img">
        <img
            src="/lyons.peru/images/gorritaua.jpg"
            alt="imagen-producto"
        />
    </div>
    <div class="container-info-product">
        <div class="container-price">
            <span>Gorro Hombre Running </span>
        </div>
        ...
        <div class="container-add-cart">
            ...
            <div class="product" data-product-name="Gorro Hombre Running" data-product-price="55.99">
        ...
        <div class="container-description">
            ...
            <div class="text-description">
                <p>
                    Under Armour Shadow Run es un gorro deportivo de hombre diseñado para que entrenes o salgas a correr con comodidad. Es ligero, ajustado, súper transpirable.
                </p>
            </div>
        </div>
