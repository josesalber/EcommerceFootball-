...
<main>
    <div class="container-img">
        <img
            src="/lyons.peru/images/pelota.jpg"
            alt="imagen-producto"
        />
    </div>
    <div class="container-info-product">
        <div class="container-price">
            <span>Nike FC Barcelona Amarillo </span>
        </div>
        ...
        <div class="container-add-cart">
            ...
            <div class="product" data-product-name="Nike FC Barcelona Amarillo" data-product-price="129.99">
        ...
        <div class="container-description">
            ...
            <div class="text-description">
                <p>
                    FC Barcelona Strike es una pelota de fútbol que los hinchas del equipo culé llevarían a un partido con sus amigos. Un diseño texturizado de 12 paneles crea un toque consistente en todo el campo y las ranuras incorporadas crean un vuelo más estable para esos tiros de práctica y juego.
