...
<main>
    <div class="container-img">
        <img
            src="/lyons.peru/images/arquero.jpg"
            alt="imagen-producto"
        />
    </div>
    <div class="container-info-product">
        <div class="container-price">
            <span>Guantes de arquero X </span>
        </div>
        ...
        <div class="container-add-cart">
            ...
            <div class="product" data-product-name="Guantes De Arquero X" data-product-price="129.99">
        ...
        <div class="container-description">
            ...
            <div class="text-description">
                <p>
                    adidas Guantes de arquero X son unos guantes de arquero que te permiten llegar a todos los remates gracias a su diseño ligero. Se han confeccionado en un tejido de malla flexible con una banda elástica en la muñeca que te ofrece un ajuste seguro. En el exterior, la palma de látex Soft Grip te ayuda a agarrar la pelota y amortiguar los tiros con fuerza.
