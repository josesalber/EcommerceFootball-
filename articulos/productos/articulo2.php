...
<main>
    <div class="container-img">
        <img
            src="/lyons.peru/images/canguro.jpg"
            alt="imagen-producto"
        />
    </div>
    <div class="container-info-product">
        <div class="container-price">
            <span>Nike Challenger 2 </span>
        </div>
        ...
        <div class="container-add-cart">
            ...
            <div class="product" data-product-name="Nike Challenger 2" data-product-price="129.99">
        ...
        <div class="container-description">
            ...
            <div class="text-description">
                <p>
                    Nike Challenger 2 es una canguro ideal para guardar cosas esenciales mientras acumulas kilómetros. El compartimento principal con cierre cuenta con un divisor para mantener los objetos organizados. El diseño ligero y moldeado aporta comodidad y elimina el rebote. Mantén la frescura con una malla en la parte posterior que mejora la transpirabilidad.
                </p>
            </div>
        </div>
