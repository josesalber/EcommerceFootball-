                ...
                <div class = "collection-list mt-4 row gx-0 gy-3">
                    <div class = "col-md-6 col-lg-4 col-xl-3 p-2 best">
                        ...
                        <div class = "collection-img position-relative">
                            <a href="/lyons.peru/articulos/productos/articulo1.php"> <img src = "../images/gorritaua.jpg" class = "w-100"></a>
                            
                        </div>
                        <div class = "text-center">
                            <p class = "text-capitalize my-1">Gorro Hombre Running</p>
                            <span class = "fw-bold">S/55.99 </span>
                        </div>
                    </div>

                    <div class = "col-md-6 col-lg-4 col-xl-3 p-2 feat">
                        <div class = "collection-img position-relative">
                            <a href="/lyons.peru/articulos/productos/articulo2.php"> <img src = "../images/canguro.jpg" class = "w-100"></a>
                        </div>
                        <div class = "text-center">
                            <p class = "text-capitalize my-1">Nike Challenger 2</p>
                    ...
                    <div class = "col-md-6 col-lg-4 col-xl-3 p-2 new">
                        <div class = "collection-img position-relative">
                            <a href="/lyons.peru/articulos/productos/articulo3.php"><img src = "../images/guantes.jpg" class = "w-100"></a>
                        </div>
                        <div class = "text-center">

                            <p class = "text-capitalize my-1">Nike Men's Fundamental Training</p>
                            <span class = "fw-bold">S/79.99</span>
                        </div>
                    </div>

                    <div class = "col-md-6 col-lg-4 col-xl-3 p-2 best">
                        <div class = "collection-img position-relative">
                            <a href="/lyons.peru/articulos/productos/articulo4.php"><img src = "../images/tomatodo.jpg" class = "w-100"></a>
                        </div>
                        <div class = "text-center">

                            <p class = "text-capitalize my-1">Botella Nike tr Renew Recharge</p>
                            <span class = "fw-bold">S/99.99</span>
                        </div>
                    </div>

                    <div class = "col-md-6 col-lg-4 col-xl-3 p-2 feat">
                        <div class = "collection-img position-relative">
                            <a href="/lyons.peru/articulos/productos/articulo5.php"><img src = "../images/pesas.jpg" class = "w-100"></a>
                        </div>
                        <div class = "text-center">

                            <p class = "text-capitalize my-1">Energetics Pesas Fitness Neopreno</p>
                            <span class = "fw-bold">S/113.99 </span>
                        </div>
                    </div>

                    <div class = "col-md-6 col-lg-4 col-xl-3 p-2 new">
                        <div class = "collection-img position-relative">
                            <a href="/lyons.peru/articulos/productos/articulo6.php"><img src = "../images/bolso.jpg" class = "w-100"></a>
                        </div>
                        <div class = "text-center">
                            
                            <p class = "text-capitalize my-1">Nike Bolsa Brasilia</p>
                            <span class = "fw-bold">S/189.99</span>
                        </div>
                    </div>

                    <div class = "col-md-6 col-lg-4 col-xl-3 p-2 best">
                        <div class = "collection-img position-relative">
                            <a href="/lyons.peru/articulos/productos/articulo7.php"><img src = "../images/pelota.jpg" class = "w-100"></a>
                        </div>
                        <div class = "text-center">

                            <p class = "text-capitalize my-1">Nike FC Barcelona Amarillo</p>
                            <span class = "fw-bold">S/129.99</span>
                        </div>
                    </div>
                    ...
                    <div class = "col-md-6 col-lg-4 col-xl-3 p-2 feat">
                        <div class = "collection-img position-relative">
                            <a href="/lyons.peru/articulos/productos/articulo8.php"><img src = "../images/arquero.jpg" class = "w-100"></a>
                        </div>
                        <div class = "text-center">
                            <p class = "text-capitalize my-1">Guantes de arquero X</p>
                            <span class = "fw-bold">S/129.99</span>
                        </div>
                    </div>
                </div>
